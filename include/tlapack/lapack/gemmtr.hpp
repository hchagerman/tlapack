 ...
 * * @param[in,out] C A n-by-m matrix.
 * @ingroup blas3
 */
template <TLAPACK_MATRIX matrixA_t,
          TLAPACK_MATRIX matrixB_t,
            ...
            matrixC_t& C)
{
    ...
    //         //         for (idx_t k = 0; k < n; ++k) {
    //         //             for (idx_t j = 0; j < k; ++j) {
    //         //                 const scalar_t alphaAjk = alpha * conj(A(j,
    //         k));
    //         //                 for (idx_t i = 0; i < m; ++i)
    //         //                     B(i, j) += B(i, k) * alphaAjk;
    //         //             }
    //         //             {
    //         //                 const scalar_t alphaAkk = (diag ==
    //         Diag::NonUnit)
    //         //                                               ? alpha *
    //         conj(A(k,
    //         //                                               k)) : alpha;
